...
def search():
    if request.method == "GET":
        ...
        with ix.searcher() as searcher:
                ...
                return render_template('search.html', search_text=request.args["query"], highlight_canon_num=(query_result[0]["results"][0]["canon_num"] if len(query_result) > 0 else ""), highlight=(query_result[0]["results"][0].highlights("content") if len(query_result) else "No Result"), sections=query_result)
